...
import ru.siestavl.siestavl.fragments.FilmDescription;
import ru.siestavl.siestavl.fragments.TabContainer;
...
public class MainActivity extends FragmentActivity
    ...
    public void onSectionAttached(int number) {
        switch (number) {
            case 1:
                mTitle = getString(R.string.navigation_drawer_main);
                break;
            case 2:
                mTitle = getString(R.string.navigation_drawer_login);
                break;
            case 3:
                mTitle = getString(R.string.navigation_drawer_cart);
                break;
        }
    }
