...
public class TabContainer extends Fragment {
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                ...
                if (keyCode == KeyEvent.KEYCODE_BACK) {
                    ...
                    if(mViewPager.getCurrentItem() == 0) {
                        if (mViewPagerAdapter.getItem(0) instanceof CuisineList ||
                                mViewPagerAdapter.getItem(0) instanceof CuisineDetail) {
                            ((TabFragment) mViewPagerAdapter.getItem(0)).backPressed();
                            return true;
                        } else if (mViewPagerAdapter.getItem(0) instanceof MenuTab) {
                            return false;
                        }
                    }
                    return true;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mViewPagerAdapter =  new ViewPagerAdapter(getFragmentManager(), Titles, Numboftabs);
